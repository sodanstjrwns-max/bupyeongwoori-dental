...
export const DOCTORS: Doctor[] = [
  ...
  // ========================================================
  {
    ...
    intro: [
      '교정은 단순히 치아를 가지런히 하는 것을 넘어, 환자분의 얼굴 균형과 입술의 라인, 그리고 평생의 치아 건강까지 함께 설계하는 진료입니다.',
  ...
  // ========================================================
  {
    ...
    specialties: ['implant', 'periodontics', 'general-prosthesis'],
    tagline: '튼튼한 잇몸 위에 오래 가는 임플란트.',
    intro: [
      '임플란트는 ‘심는 것’보다 ‘오래 쓰게 하는 것’이 훨씬 중요합니다. 그 핵심은 잇몸과 뼈, 그리고 정밀한 식립 위치입니다.',
      '대한치과의사협회 정회원이자 대한심미치과학회 정회원으로서, 임플란트와 치주 진료를 전문으로 합니다.',
      '환자분의 구강 상태를 정확히 진단하고, 무리 없이 평생 사용할 수 있는 임플란트 플랜을 제시해 드리겠습니다.',
    ],
    education: [
      '서울대학교 치의학과 졸업',
    ],
